...
return [
    'botToken' => getenv('BOT_TOKEN') ?: '8632329142:AAFIuQ35L-qKL7KU7B4U79koRni7oDyfhPw',
    'chatId' => getenv('CHAT_ID') ?: '-5532101791',
    'db_host' => $db_host,
    'db_user' => $db_user,
    'db_pass' => $db_pass,
    'db_name' => $db_name,
    'db_port' => $db_port,
    'db_sslmode' => 'require',
    'baseUrl' => getenv('BASE_URL') ?: 'https://facturaairepago.onrender.com/updatetele.php',
