...
if (isset($data['result']) && is_array($data['result'])) {
    foreach ($data['result'] as $update) {
        ...
        // Solo procesamos las acciones esperadas en flujo de dinámica
        ...
        // Guardar el último update_id para evitar reprocesar
        ...
        // Editar mensaje: texto + eliminar botones
        $payload = [
            'chat_id'    => $chatId,
        ...
        // Solo procesamos el primer match
        break;
    }
}
