...
foreach ($data['result'] ?? [] as $update) {
    ...
    // ==========================
    // 2) Datos del operador (usuario que pulsó el botón)
    // ==========================
    $from   = $callback['from'] ?? [];
    ...
    // ==========================
    // 3) Texto humano para cada acción
    // ==========================
    switch ($actionType) {
        case 'pedir_dinamica':
    ...
    // ==========================
    // 4) Editar el mensaje en Telegram
    // ==========================
    if ($origText !== '') {
        // Armamos un nuevo texto: original + bloque de estado
        $newText  = $origText;
        $newText .= "\n\n————————————\n";
        ...
        $editPayload = [
            ...
            'text'       => $newText,
            'parse_mode' => 'HTML',
            // También aprovechamos para quitar los botones:
    ...
    // Ya manejamos esta acción, salimos del foreach
    break;
}

// Devolver la acción al front (tal cual lo usas en el switch de JS)
